...
| At risk vs Non-risk | 3 public dataset: HESP, XAPI, UCI, Demographic, Academic, and Behavior, train:test(80:20) | CNN + BIGRU, ANN and LSTM, BILSM, GRU, BIGRU| accuracy, precision, recall, and F1 | hybrid DNN, SMOTE, hyper-tune | ----------- | [2025](https://github.com/soklayheng/AIED/blob/main/references/mca-30-00059.pdf)|  |
