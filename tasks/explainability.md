...
| Score Prediction, Explainability for both local and global levels | Public dataset: CodeWorkout, 772 students, code submission info for different assignments | stacked ensemble model (KNN, SVM, and XGBoost) as the base models and LR as the meta-model, begging, boosting, LR | RMSE and R<sup>2</sup>| K-Fold 10, hyper-tune, SHAP for individual and a global level; force plot + summary plot for individual explanation and shap value for global | [2023](https://github.com/soklayheng/AIED/blob/main/references/2023.EDM-long-papers.7.pdf) | ---- |
