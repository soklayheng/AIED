...
| Propose self-service, teacher-facing learning analytics dashboard where teachers can build and refine dashboard charts by using natural-language requests
 | Collected classroom data from a VR story-creation learning platform (LAVR) used in a university course, including student info, 
	VR story artifacts, peer reviews, and behavior logs/clickstreams | GPT-4o vs GPT-4o mini | Store the student's collected data in PostgreSQL database. Prompt-engineering  to retrieve data from SQL, Vega specification for Chart rendering. Usability testing with teachers.| |  [2025](https://github.com/soklayheng/AIED/blob/main/references/lak2025-23.pdf) | 
